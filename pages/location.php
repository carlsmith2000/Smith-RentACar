...
<body>
    ...
    <form action="location.php" method="POST">
        ...
        <div>
            <input type="date" name="dateDebutLoc">
            <input type="time" name="heureDebutLoc">
        </div>

        <div>
            <input type="date" name="dateFinLoc">
            <input type="time" name="heureFinLoc">
        </div>

        <select name="pays">
            <option value="Haiti" selected="selected">Pays De ramassage</option>
